...
public class AutoLogic 
{
	...
	{	
		...
		_chooser.addOption("DFDTest", "DFDTest");
		_chooser.addOption("SFDTest", "SFDTest");
		_chooser.addOption("PullInTest", "PullInTest");
		_chooser.addOption("AutoGroupToScaleDump", "ScaleTest");
		
		SmartDashboard.putData("Auto mode", _chooser);
		
		_chooserPosition.addOption("Default Position(Center)", "center");
		_chooserPosition.addOption("left", "left");
		_chooserPosition.addOption("center", "center");
		_chooserPosition.addOption("right", "right");
		_chooserPosition.addOption("Test Only", "test");
